...
<!--
  Note: these three widgets (stats, streak, activity graph) all live on the free
  public Vercel instances of anuraghazra/github-readme-stats and DenverCoder1/github-readme-streak-stats.
  Those shared instances occasionally get GitHub-API rate limited and show
  "Something went wrong" for a few minutes — it's a known, long-running upstream
  issue, not something wrong with this file. If it happens often, self-host with
  your own token: https://github.com/anuraghazra/github-readme-stats#deploy-on-your-own
-->
...
<p align="center">
  <img
    src="https://github-profile-trophy.vercel.app/?username=jayanithyan&theme=tokyonight&no-frame=true&row=1&column=6"
    width="90%"
    alt="Jayanithyan GitHub Trophies"
  />
</p>
...
<details>
<summary>🔧 One-time setup to activate the snake above (click to expand)</summary>

This image only appears once you turn it on in **your** `jayanithyan/jayanithyan` repo — it's self-hosted, so it never depends on a third-party API and won't go down.
...
3. GitHub creates an `output` branch with the SVGs — the image above will start rendering automatically after that.
